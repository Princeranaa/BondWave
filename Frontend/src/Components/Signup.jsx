            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
              ...
              <div className="form-control">
                ...
                <select
                  ...
                  className="select select-sm bg-base-200 border-none h-10"
                >
              ...
              <div className="form-control md:col-span-2">
                ...
                <input
                  ...
                  className="input input-sm bg-base-200 border-none h-10"
                />
              </div>
              ...
              <div className="form-control md:col-span-2">
                ...
                <textarea
                  ...
                  className="textarea textarea-sm bg-base-200 border-none h-20 resize-none"
